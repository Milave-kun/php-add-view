...
<div class="container-lg">
    ...
    <table class="table mt-3">
        ...
        <tbody>
            <?php
                $sql = "SELECT * FROM info WHERE course = 'HUMMS' AND year = '11'";
...
<div class="container-lg">
    ...
    <table class="table mt-3">
        ...
        <tbody>
            <?php
                $sql = "SELECT * FROM info WHERE course = 'HUMMS' AND year = '12'";
                $result = mysqli_query($conn, $sql);
