...
<div class="container-lg">
    ...
    <table class="table mt-3">
        ...
        <tbody>
            <?php
                $sql = "SELECT * FROM info WHERE course = 'BSOA' AND year = '1st'";
...
<div class="container-lg">
    ...
    <table class="table mt-3">
        ...
        <tbody>
            <?php
                $sql = "SELECT * FROM info WHERE course = 'BSOA' AND year = '2nd'";
                $result = mysqli_query($conn, $sql);
...
<div class="container-lg">
    ...
    <table class="table mt-3">
        ...
        <tbody>
            <?php
                $sql = "SELECT * FROM info WHERE course = 'BSOA' AND year = '3rd'";
                $result = mysqli_query($conn, $sql);
...
<div class="container-lg">
    ...
    <table class="table mt-3">
        ...
        <tbody>
            <?php
                $sql = "SELECT * FROM info WHERE course = 'BSOA' AND year = '4th'";
                $result = mysqli_query($conn, $sql);
